...
#else
    /* miniupnpc 1.9.20150730 and later added a TTL argument */
    int error = 0;
    devlist = upnpDiscover(2000, multicastif, minissdpdpath, 0, 0, /* TTL */ 2, &error);
#endif
...
void StartNode(void* parg)
{
    ...
    // IRC peer discovery (irc.freenode.net) was removed during modernization:
    // the network is long defunct.  DNS seeding above is the discovery path.
